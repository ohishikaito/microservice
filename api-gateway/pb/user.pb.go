...
var file_user_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x22, 0xc8, 0x01, 0x0a, 0x04,
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0xbe, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3f, 0x0a, 0x0b, 0x44, 0x65, 0x73, 0x74, 0x72, 0x6f,
	0x79, 0x55, 0x73, 0x65, 0x72, 0x12, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x73, 0x74, 0x72,
	0x6f, 0x79, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e,
...
var file_user_proto_depIdxs = []int32{
	...
	1,  // 7: pb.UserService.GetUser:input_type -> pb.GetUserRequest
	3,  // 8: pb.UserService.CreateUser:input_type -> pb.CreateUserRequest
	5,  // 9: pb.UserService.UpdateUser:input_type -> pb.UpdateUserRequest
	7,  // 10: pb.UserService.DestroyUser:input_type -> pb.DestroyUserRequest
	0,  // 11: pb.UserService.GetUsers:output_type -> pb.GetUsersResponse
	2,  // 12: pb.UserService.GetUser:output_type -> pb.GetUserResponse
	4,  // 13: pb.UserService.CreateUser:output_type -> pb.CreateUserResponse
	6,  // 14: pb.UserService.UpdateUser:output_type -> pb.UpdateUserResponse
	10, // 15: pb.UserService.DestroyUser:output_type -> google.protobuf.Empty
...
func (c *userServiceClient) DestroyUser(ctx context.Context, in *DestroyUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (*UnimplementedUserServiceServer) DestroyUser(context.Context, *DestroyUserRequest) (*emptypb.Empty, error) {
...
func _UserService_DestroyUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).DestroyUser(ctx, req.(*DestroyUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
